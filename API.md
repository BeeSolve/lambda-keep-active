...
| <code><a href="#@beesolve/lambda-keep-active.LambdaKeepActive.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="@beesolve/lambda-keep-active.LambdaKeepActive.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="@beesolve/lambda-keep-active.LambdaKeepActive.with.parameter.mixins"></a>
